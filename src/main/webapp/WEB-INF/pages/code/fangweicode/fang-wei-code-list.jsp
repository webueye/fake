...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form id="validateForm" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/fang-wei-code/search">
				<div class="search">
					<div class="row">
						<div class="span12">
							<div class="control-group">
					            ...
					            <input name="filter_EQS_codeType" value="fangWeiCode" type="hidden"/>
				...
				<div>
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="gray" colspan="10">码列表</th>
							</tr>
							<tr>
								<th>编号</th>
								<th>生成标题</th>
