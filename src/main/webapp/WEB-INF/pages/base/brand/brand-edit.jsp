					...
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr class="th">
								...
								<td class="ltd"> 
									启用<input class="input-xlarge required" name="status" style="margin-right: 20px;" value="true" type="radio" ${brand.status? 'checked':''}/>
									禁用<input class="input-xlarge required" name="status" value="false" type="radio" ${brand.status? '':'checked'}/>
								</td>
							</tr>
							<tr class="th">
